 ...
 * @param <T>
 */
public class CircularOneWaySelfArrangingLinkedList<T extends Comparable<T>> implements Iterable<T> {
    ...
    public CircularOneWaySelfArrangingLinkedList(){
        
        this(false);
        
    } //End of constructor.
    
    public CircularOneWaySelfArrangingLinkedList(boolean isDescendingOrderP){
    ...
    @Override
    public CircularOneWaySelfArrangingLinkedListIterator<T> iterator() {
            
        CircularOneWaySelfArrangingLinkedListIterator listIterator = new CircularOneWaySelfArrangingLinkedListIterator(this);
